    ...
    [react/view {:style (styles/card window-width)}
     [react/view {:padding 16}
      ...
      [react/text {:number-of-lines 1 :ellipsize-mode :middle
                   :style {:width (/ window-width 2) :line-height 22
    ...
    (let [{:keys [tab]} @state]
      [react/view {:flex 1}
       [react/view {:flex-direction :row :margin-bottom 8 :padding-horizontal 16}
        [accounts/tab-title state :assets (i18n/label :t/wallet-assets) (= tab :assets) true]
        (when (seq nfts)
   ...
   [react/scroll-view
    [react/view {:padding-left 16}
     [react/scroll-view {:horizontal true}
      [react/view {:flex-direction :row :padding-top 8 :padding-bottom 24}
       [account-card]]]]
