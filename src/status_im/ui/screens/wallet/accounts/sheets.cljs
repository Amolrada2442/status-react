...
(defn add-account []
  [react/view
   [action-button/action-button {:label               (i18n/label :t/add-an-account)
                                 ...
                                 :icon-opts           {:color :blue}
                                 :on-press            #(hide-sheet-and-dispatch [:navigate-to :wallet-send-transaction])}]
   [action-button/action-button {:label               (i18n/label :t/add-a-watch-account)
...
(defn account-settings []
  [react/view
   [action-button/action-button {:label               (i18n/label :t/account-settings)
                                 :icon                :main-icons/info
                                 :icon-opts           {:color :blue}}]
   [action-button/action-button {:label               (i18n/label :t/export-account)
